  ...
  return (
    <div className="stack">
      <div className="card">
        ...
        <div className="muted">
          Admin and superadmin only. These controls call the reporting endpoints
        ...
        <div className="card card-subtle" style={{ marginTop: 12 }}>
          <div className="h2">Tech and activity filters</div>
          <p className="muted" style={{ marginTop: 8 }}>
            Use either <code>days</code> or a <code>start</code>/<code>end</code>{" "}
            range.
          </p>
          ...
          <div className="grid grid-3">
            <label className="field">
              ...
              <input
                ...
                disabled={!!loadingKey}
              />
              <div className="field-hint">Used when start/end are not both set.</div>
            </label>
            ...
            <label className="field">
              ...
              <input
                ...
                disabled={!!loadingKey}
              />
              <div className="field-hint">End is exclusive per contract.</div>
            </label>
          </div>
          ...
          <div className="row" style={{ marginTop: 12 }}>
            <button
              className="btn"
              disabled={!!loadingKey}
              onClick={() => run("techs", () => reportsTechsApi(techsParams()), setTechs)}
            >
            ...
            <button
              ...
              disabled={!!loadingKey}
              onClick={() =>
                run("activity", () => reportsActivityApi(techsParams()), setActivity)
              }
            >
        ...
        {loadingKey ? <LoadingBlock title={`Loading ${loadingKey}...`} /> : null}
      </div>
